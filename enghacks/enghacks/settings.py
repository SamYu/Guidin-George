"""
Django settings for enghacks project.
...
SECRET_KEY = 'oml=wor8-f=#wyucbcltt)0uso4o40$+5aybvy#%p+imjd)7q4'
...
WSGI_APPLICATION = 'enghacks.wsgi.application'
...
GOOGLE_MAPS_KEY = 'AIzaSyBadB6G00B0XCY3GoybhFADV9ZnrOP_Usw'